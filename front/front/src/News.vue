                    ...
                    <v-row style="margin-top: 4%; margin-bottom: 1%;">
                        ...
                        <div v-else>
                            <v-col align="end" style="padding-right: 0;">
                                ...
                                <p style="color: #950400;"><i @click="async () => {await myStore.changeNewsLike(this.news.id)}" class="material-icons">favorite_border</i>{{ myStore.getNumberOfNewsLikes(this.news.id) }}</p>
                            </v-col>
                        </div>
                    </v-row>
